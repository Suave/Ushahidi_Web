...
?>
	...
	'<?php echo(utf8_encode($page_id)); ?>',
	'<?php echo(utf8_encode($page_title)); ?>',
	'<?php echo(utf8_encode($page_tab)); ?>',
	'<?php echo(utf8_encode($page_description)); ?>')"><?php echo Kohana::lang('ui_main.edit');?></a></li>
