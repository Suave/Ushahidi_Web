...
?>
	...
	'<?php echo(urlencode($page_id)); ?>',
	'<?php echo(urlencode($page_title)); ?>',
	'<?php echo(urlencode($page_tab)); ?>',
	'<?php echo(urlencode($page_description)); ?>')"><?php echo Kohana::lang('ui_main.edit');?></a></li>
