	...
	<div class="rapidxwpr floatholder">
		...
		<div id="header">
			...
			<div id="searchbox">
				...
				<span >分享到:</span>
				<a style="margin-top:4px" target="_blank" href="http://www.douban.com/recommend/?url=<?php echo 'http://'.$_SERVER['SERVER_NAME'].$_SERVER["REQUEST_URI"]; ?>&title=救灾信息网" ><img src="http://www.jiuzai.info//media/img/douban.gif" alt="share to douban"/></a>
	        		<a style="margin-top:4px" target="_blank" href="http://share.renren.com/share/buttonshare.do?link=<?php echo 'http://'.$_SERVER['SERVER_NAME'].$_SERVER["REQUEST_URI"]; ?>&title=救灾信息网"><img src="http://www.jiuzai.info//media/img/renren.gif" alt="share to renren"/></a>
				<a style="margin-top:4px" target="_blank" href="http://www.kaixin001.com/repaste/share.php?rurl=<?php echo 'http://'.$_SERVER['SERVER_NAME'].$_SERVER["REQUEST_URI"]; ?>&rtitle=jiuzai.info&rcontent=救灾信息网" ><img src="http://www.jiuzai.info//media/img/kaixin001.gif" alt="share to kaixin001"/></a>
				<span>让更多的人知道。</span>
				</div>
